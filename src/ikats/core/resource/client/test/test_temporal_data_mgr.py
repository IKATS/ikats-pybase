...
TEST_HOST = CF.get('cluster', 'tdm.ip')
TEST_PORT = int(CF.get('cluster', 'tdm.port'))
...
class TestTemporalDataMgr(TestCase):
    ...
    def test_import_data_set(self):
        ...
        results = tdm.import_data_set('id_of_data_set', 'description of my data set', ['TSUID1', 'TSUID2', 'TSUID3'])
    ...
    def test_remove_data_set(self):
        ...
        tdm = TemporalDataMgr(TEST_HOST, TEST_PORT)
        status = tdm.remove_data_set('id_of_data_set')
    ...
    def test_remove_data_set_unknown(self):
        ...
        tdm = TemporalDataMgr(TEST_HOST, TEST_PORT)
        status = tdm.remove_data_set('unknown data set')
