...
from ikats.core.resource.client import TemporalDataMgr, NonTemporalDataMgr
...
class IkatsGenericApiEndPoint(object):
    ...
    def create(*args, **kwargs):
        ...
        :raises NotImplementedError: until it is implemented in children class
        """
...
class IkatsProcessData(IkatsGenericApiEndPoint):
    """
...
# noinspection PyMethodOverriding,PyAbstractClass
class IkatsTable(IkatsGenericApiEndPoint):
    """
...
class IkatsTimeseries(IkatsGenericApiEndPoint):
    """
    ...
    def create_ref(fid):
        ...
        :rtype: str
        """
        return Wrapper.create_tsuid(fid=fid)
    ...
    def create(fid, data=None, generate_metadata=True, parent=None, *args, **kwargs):
        ...
        :rtype: dict
        """
        return Wrapper.import_ts(fid=fid, data=data, generate_metadata=generate_metadata, parent=parent, *args,
                                 **kwargs)

    @staticmethod
    def inherit(tsuid, parent, *args, **kwargs):
        """
        Make a time serie inherit of parent's metadata according to a pattern (not all metadata inherited)
        ...
        :param parent: str
        """
        return Wrapper.inherit_properties(tsuid=tsuid, parent=parent, *args, **kwargs)
    ...
    def nb_points(tsuid, ed=None):
        ...
        return Wrapper.get_nb_points_from_tsuid(tsuid=tsuid, ed=ed)
...
# noinspection PyMethodOverriding,PyAbstractClass
class IkatsMetadata(IkatsGenericApiEndPoint):
    """
...
# noinspection PyMethodOverriding,PyAbstractClass
class IkatsDataset(IkatsGenericApiEndPoint):
    """
    ...
    def read(ds_name):
        ...
        :param ds_name: name of the data set to request TS list from
        :type ds_name: str
        ...
        tdm = TemporalDataMgr()
        return tdm.get_data_set(data_set=ds_name)

    @staticmethod
    def delete(ds_name, deep=False):
        """
        Remove data_set from base

        :param ds_name: name of the data set to delete
        :type ds_name: str
        ...
        tdm = TemporalDataMgr()
        return tdm.remove_data_set(data_set=ds_name, deep=deep)
    ...
    def list():
        ...
        tdm = TemporalDataMgr()
        return tdm.get_data_set_list()


class IkatsApi(object):
    """
    Ikats resources API
